...
const tableData: LocationRow[] = [
  ...
  {
    id: "LOC-04",
    location: "Hill Avenue — Public Garden Gate",
    category: "Fallen Tree",
    reports: 14,
    severity: "Medium",
    department: "Parks & Tree Maintenance Department",
    status: "Assigned",
  },
  {
    id: "LOC-05",
    location: "South Avenue — Flood Risk Zone 3",
    category: "Flood",
    reports: 12,
    severity: "Critical",
    department: "Disaster Management & Emergency Response Department",

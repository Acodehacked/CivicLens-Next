...
const categoryData = [
  ...
  { name: "Garbage", value: 711, pct: 25, color: "#3B82F6" },
  { name: "Waterlogging", value: 512, pct: 18, color: "#60A5FA" },
  { name: "Fallen Trees", value: 380, pct: 13, color: "#93C5FD" },
  { name: "Floods", value: 161, pct: 6, color: "#BFDBFE" },
];
